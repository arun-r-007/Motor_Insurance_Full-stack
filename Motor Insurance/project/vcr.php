...
<br><br><br><br><br>
    <div class="container">
        <h2><i>CLAIM REQUEST</i></h2><br><br><br>
        ...
        <ul class="responsive-table" id="paymentTable">
            ...
            if ( 1) {
                ...
                $sql_request_claim = "SELECT cname, vehicle_num, date_time, request FROM request_claim";
                $result_request_claim = $conn->query($sql_request_claim);

                if ($result_request_claim->num_rows > 0) {
                    while ($row = $result_request_claim->fetch_assoc()) {

                        

                        echo "<li class='table-row'>
                                <div class='col col-1' data-label='Claimant Name'>" . htmlspecialchars($row['cname']) . "</div>
                                <div class='col col-2' data-label='Vehicle Number'>" . htmlspecialchars($row['vehicle_num']) . "</div>
                                <div class='col col-3' data-label='Date Time'>" . htmlspecialchars($row['date_time']) . "</div>
                                <div class='col col-4' data-label='Request'>" . htmlspecialchars($row['request']) . "</div>
                            </li>";
                    }
                } else {
